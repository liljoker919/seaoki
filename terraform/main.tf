# Terraform Configuration for Sea OKI Collection AWS Infrastructure
# This file provisions S3, CloudFront, ACM, and Route 53 resources
...
resource "aws_cloudfront_distribution" "website" {
  ...
  comment             = "${var.project_name} - Managed by Terraform"
